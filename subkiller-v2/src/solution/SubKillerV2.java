 ...
 */
public class SubKillerV2 extends Application {
    ...
    private int misses = 0;//added by hfh
    private int hits = 0;//added by hfh
    ...
    public void draw() {
        ...
        g.setFill(Color.rgb(50,150,200));
